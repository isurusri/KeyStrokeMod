package com.isuru.keystrokesmod.render;

import com.isuru.keystrokesmod.KeystrokesMod;
import com.isuru.keystrokesmod.KeystrokesSettings;
    ...
    this.buttonList.add(
        this.buttonEnabled =
            new GuiButton(
                ...
                140,
                20,
                "Enabled: " + (settings.isEnabled() ? "On" : "Off")));
    this.buttonList.add(
        this.buttonShowMouseButtons =
            new GuiButton(
                1,
                this.width / 2 - 70,
                this.height / 2 - 6,
    ...
    this.buttonList.add(
        this.buttonTextColor =
            new GuiButton(
                ...
                140,
                20,
                "Text color: " + GuiScreenKeystrokes.COLOR_NAMES[settings.getTextColor()]));
  }
      ...
      case 1:
        {
          ...
          this.buttonShowMouseButtons.displayString =
              "Show mouse buttons: " + (settings.isShowingMouseButtons() ? "On" : "Off");
        }
      case 2:
        {
          settings.setTextColor((settings.getTextColor() == 6) ? 0 : (settings.getTextColor() + 1));
          this.buttonTextColor.displayString =
              "Text color: " + GuiScreenKeystrokes.COLOR_NAMES[settings.getTextColor()];
          break;
        }
    }
